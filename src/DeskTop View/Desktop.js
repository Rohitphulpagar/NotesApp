          ...
          <div className="groupNamess">
            {groupNames.map((group, index) => (
              ...
              >
                ...
                <span className="GroupNamesCategorys">{group.name}</span>
              </li>
            ))}
          </div>
        </section>
                ...
                <div>
                  <div className="headingSection22">
                    <span className="headingSection33">
                      ...
                      <span className="profileNames2">
                        {groupSelected.name.slice(0, 2)}
                      </span>
                  ...
                  <div>
                    <form onSubmit={SubmitDescription}>
                      <div className="combineTwos">
                        <div className="date">{currentDates}</div>
                        <div className="descs">{groupSelected.description}</div>
                      </div>
                      <div className="textAreass">
                        <textarea
                          value={groupSelected.description}
                          onChange={(e) =>
                            WriteGroupDescription(e.target.value)
                          }
